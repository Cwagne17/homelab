...
- [x] 2. Implement Packer image builder for AlmaLinux 9 + k3s

  - Create packer/alma9-k3s-optimized directory structure
  - _Requirements: 1.1, 8.4, 8.5_

- [x] 2.1 Create Packer variables configuration
...
- [x] 2.2 Create Packer builder configuration
...
- [x] 2.3 Create kickstart configuration for automated installation
...
- [x] 2.7 Create security hardening stub script
...
- [x] 3.2 Create k3s-single environment configuration
...
- [x] 4.2 Create Argo CD app-of-apps configuration
...
- [x] 4.3 Create root kustomization for home cluster

  - Write k8s/clusters/home/kustomization.yaml referencing bootstrap/, infra/, and apps/
  - _Requirements: 5.3, 5.4_

- [x] 4.4 Create phpIPAM example application manifests
...
- [x] 6.1 Create preflight validation script
